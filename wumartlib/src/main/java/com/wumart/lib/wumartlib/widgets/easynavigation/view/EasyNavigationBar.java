package com.wumart.lib.wumartlib.widgets.easynavigation.view;
...
import com.wumart.lib.wumartlib.widgets.easynavigation.adapter.ViewPagerAdapter;
import com.wumart.lib.wumartlib.widgets.easynavigation.constant.Anim;
import com.wumart.lib.wumartlib.widgets.easynavigation.utils.NavigationUtil;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    public void buildAddNavigation() {
        ...
        tabCount = titleItems.length;
        if (tabCount % 2 == 0) {
            Log.e("EasyNavigation", "MODE_ADD模式下请传入奇数数量的Tab文字集合、未选中图标集合、选中图标集合");
            return;
        }
